...
unsigned long long r_jcong64 = 67422705, xorsh_x, xorsh_s[2] = {31964026,85252204};
...
void settable(unsigned long i1,unsigned long i2,unsigned long i3,unsigned long i4,unsigned long i5,unsigned long i6) {
	...
	int i; gm_r_z=i1; gm_r_w=i2; gm_r_jsr=i3 | 1; gm_r_jcong=i4; gm_r_a=i5; gm_r_b=i6;
	for(i=0;i<256;i=i+1) gm_r_t[i]=KISS();
   xorsh_s[0] = KISS() | 1;
   xorsh_s[1] = KISS();
   unsigned long long r = KISS();
   r_jcong64 = r;
}
